...
@app.route('/')
def index():
    css_file = url_for('static', filename='css/styles.css', v='1.15233')
...
def show_post(id):
    ...
    css_file = url_for('static', filename='css/styles.css', v='1.15234')
...
@app.route('/aboutme')
def about_me():
    css_file = url_for('static', filename='css/styles.css', v='1.1523357')
